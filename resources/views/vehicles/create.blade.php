                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="type" id="type" class="mt-1 block w-full border-gray-300 rounded-md" required>
                                ...
                                <option value="angkutan_orang" {{ old('type') == 'angkutan_orang' ? 'selected' : '' }}>Angkutan Orang</option>
                                <option value="angkutan_barang" {{ old('type') == 'angkutan_barang' ? 'selected' : '' }}>Angkutan Barang</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select name="ownership" id="ownership" class="mt-1 block w-full border-gray-300 rounded-md" required>
                                ...
                                <option value="perusahaan" {{ old('ownership') == 'perusahaan' ? 'selected' : '' }}>Perusahaan</option>
                                <option value="sewa" {{ old('ownership') == 'sewa' ? 'selected' : '' }}>Sewa</option>
                            </select>
